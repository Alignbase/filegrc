...
const CURRENT_POLICY_REPORTING = "Suspected security events, Control failures, fraud, or policy violations must be reported promptly through the current normal Security Reporting Channel or its usable fallback. A person may use the fallback when the normal channel is unavailable, compromised, or involved in the concern.";
const PRIOR_POLICY_REPORTING = "Suspected security events, Control failures, fraud, or policy violations must be reported promptly through the current primary Security Reporting Route or its current usable alternate route. A person may use the alternate route when the primary route is unavailable, compromised, or involved in the concern.";
