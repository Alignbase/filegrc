...
4. After confirming applicable controls and authoritative source systems, preview External Evidence drafts with \`npx filegrc evidence-test-drafts --preview --json\`, then explicitly create the missing drafts with \`npx filegrc evidence-test-drafts\`.
